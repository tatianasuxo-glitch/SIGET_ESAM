...
if (!$item) {
    echo "
        <section class='revision-page'>
            <div class='revision-empty'>
                <h2>Entrega no encontrada</h2>
                <p>No se encontró una entrega administrativa pendiente o revisada para este administrador.</p>
                <a href='index.php?page=admin/revision/index' class='back-link'>← Volver a revisión</a>
            </div>
        </section>
    ";
    return;
...
$paginaActual = $_GET["page"] ?? "admin/revision/detalle";
$volver = strpos($paginaActual, "revisados") !== false
    ? "admin/revisados/index"
    : "admin/revision/index";
...
<section class="revision-page">
    ...
    <div class="revision-header">
        ...
        <p>Revise la documentación enviada por el participante y registre el resultado correspondiente.</p>
    </div>
    ...
    <div class="revision-card">
                ...
                <ul>
                    <?php foreach ($archivos as $archivo): ?>
                        ...
                        <li>
                            ...
                            <?php else: ?>
                                <span><?php echo htmlspecialchars($nombreArchivo); ?></span>
                            <?php endif; ?>
        ...
        <form action="api/guardar_calificacion.php" method="POST" class="revision-form">
            ...
            <button type="submit">
                Guardar revisión administrativa
            </button>
