...
function convertirRolSistema(string $nombreRol): string
{
...
/*
|--------------------------------------------------------------------------
| Verifica contraseñas antiguas y contraseñas sincronizadas con hash
|--------------------------------------------------------------------------
| Usuarios antiguos:
|   contraseña guardada como texto normal.
|
| Participantes externos sincronizados:
|   contraseña guardada como password_hash().
|--------------------------------------------------------------------------
*/
function verificarContrasenaSistema(string $contrasenaIngresada, string $contrasenaGuardada): bool
{
    $informacionHash = password_get_info($contrasenaGuardada);

    $esHashValido = isset($informacionHash["algo"])
        && $informacionHash["algo"] !== 0;

    if ($esHashValido) {
        return password_verify($contrasenaIngresada, $contrasenaGuardada);
    }

    return hash_equals($contrasenaGuardada, $contrasenaIngresada);
}
...
<head>
    ...
    <link rel="stylesheet" href="/SIGET_ESAM/assets/css/login_esam.css?v=3">
...
<script src="/SIGET_ESAM/assets/js/login_esam.js?v=3"></script>
