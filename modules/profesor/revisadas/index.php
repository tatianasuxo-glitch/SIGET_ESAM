...
$items = obtenerItemsRevisionPorResponsable("docente", $docenteId, "revisados");
...
<section class="revision-page">
    ...
    <div class="revision-header">
        <h1>Evaluaciones Revisadas</h1>
        <p>Historial de documentos académicos calificados por el docente.</p>
    </div>

    <?php if (isset($_GET["success"])): ?>
        <div class="revision-empty success">
            <h2>Evaluación guardada correctamente</h2>
            <p>La revisión fue registrada y ahora forma parte del historial de evaluaciones revisadas.</p>
        </div>
    <?php endif; ?>

    <form method="GET" class="revision-filters">

        <input type="hidden" name="page" value="profesor/revisadas/index">
        ...
        <div class="filter-actions">
            ...
            <a href="index.php?page=profesor/revisadas/index">Limpiar</a>
        </div>
    ...
    <?php if (empty($itemsFiltrados)): ?>
        ...
        <div class="revision-empty">
            <h2>No existen evaluaciones revisadas.</h2>
            <p>Aquí aparecerán las evaluaciones aprobadas, observadas o reprobadas por el docente.</p>
        </div>
        ...
        <div class="review-table-list">
            ...
            <?php foreach ($itemsFiltrados as $item): ?>
                ...
                <?php
                    ...
                    $fechaCalificacion = $calificacion["fecha_calificacion"] ?? "";
                ?>
                ...
                <div class="review-row">
                    ...
                    <?php if ($entregaId !== ""): ?>
                        <a 
                            class="review-action" 
                            href="index.php?page=profesor/revisadas/detalle&entrega_id=<?php echo htmlspecialchars($entregaId); ?>"
                        >
                            Ver detalle
                        </a>
                    <?php else: ?>
